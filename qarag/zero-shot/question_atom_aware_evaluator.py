...
def main(args):
    ...
    question_embeddings = np.load(args.data_dir + 'questions_atom_aware_' + args.embedder + '.npy', 'wb')
    ...
    min_indices = get_neighbours(question_embeddings, query_embeddings, args.K * 15)
